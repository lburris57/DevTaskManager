...
final class ProjectTests: XCTestCase
{
    ...
    func testUpdateProjectTitle() throws
    {
        ...
        XCTAssertGreaterThan(project.lastUpdated?.timeIntervalSince1970 ?? 0, originalLastUpdated?.timeIntervalSince1970 ?? 0, "Last updated timestamp should be newer")
        XCTAssertLessThan(project.dateCreated.timeIntervalSince1970, project.lastUpdated?.timeIntervalSince1970 ?? 0, "Date created should be before last updated")
    }
    ...
    func testUpdateProjectMultipleTimes() throws
    {
        ...
        for i in 2 ... 4
        {
            ...
            XCTAssertGreaterThan(project.lastUpdated?.timeIntervalSince1970 ?? 0, lastUpdateTime?.timeIntervalSince1970 ?? 0, "Update \(i): timestamp should increase")
    ...
    func testUpdateProjectDateTracking() throws
    {
        ...
        XCTAssertGreaterThan(project.lastUpdated?.timeIntervalSince1970 ?? 0, originalCreatedDate.timeIntervalSince1970, "Last updated should be after date created")
    }
    ...
    func testDeleteProjectWithTasks() throws
    {
        ...
        // Verify tasks behavior (depends on cascade rules)
